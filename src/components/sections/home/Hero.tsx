...
export default function Hero({
  ...
  title = 'Build next-generation apps with',
  titleHighlight = 'Acme Tech Solutions',
  description = 'Accelerate your development with our cutting-edge cloud-native platform. Deploy scalable applications 10x faster with enterprise-grade security and 99.99% uptime guarantee.',
  features = [
